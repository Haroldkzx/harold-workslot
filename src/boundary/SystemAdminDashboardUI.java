...
public class SystemAdminDashboardUI extends JFrame {

	private JPanel contentPane;
	UserAccount userAccount = new UserAccount();
	CreateUserAccountController createUserAccountController = new CreateUserAccountController(userAccount);
	ViewUserAccountController viewUserAccountController = new ViewUserAccountController(userAccount);
	UpdateUserAccountController updateUserAccountController = new UpdateUserAccountController(userAccount);
	SuspendUserAccountController suspendUserAccountController = new SuspendUserAccountController(userAccount);
	SearchUserAccountController searchUserAccountController = new SearchUserAccountController(userAccount);

	public SystemAdminDashboardUI() {
...
//			ViewUserAccount.main(new String[]{});
		...
		gl_contentPane.setHorizontalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane
				...
				.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createSequentialGroup().addGap(120).addComponent(lblAdminSection))

						.addGroup(gl_contentPane.createSequentialGroup().addGap(149)
								.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
										.addComponent(btnCreateUserAccount, GroupLayout.PREFERRED_SIZE, 170,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(btnViewUserAccount, GroupLayout.PREFERRED_SIZE, 170,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(btnUpdateUserAccount, GroupLayout.PREFERRED_SIZE, 170,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(btnSuspendUserAccount, GroupLayout.PREFERRED_SIZE, 170,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(btnSearchUserAccount, GroupLayout.PREFERRED_SIZE, 170,
												GroupLayout.PREFERRED_SIZE)

										.addComponent(btnCreateUserProfile, GroupLayout.PREFERRED_SIZE, 170,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(btnViewUserProfile, GroupLayout.PREFERRED_SIZE, 170,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(btnUpdateUserProfile, GroupLayout.PREFERRED_SIZE, 170,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(btnSuspendUserProfile, GroupLayout.PREFERRED_SIZE, 170,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(btnSearchUserProfile, GroupLayout.PREFERRED_SIZE, 170,
												GroupLayout.PREFERRED_SIZE)

										.addComponent(btnLogout, GroupLayout.PREFERRED_SIZE, 170,
												GroupLayout.PREFERRED_SIZE))))
				.addContainerGap(136, Short.MAX_VALUE)));
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane
				.createSequentialGroup().addComponent(lblAdminSection).addGap(29)
				.addComponent(btnCreateUserAccount, GroupLayout.PREFERRED_SIZE, 34, GroupLayout.PREFERRED_SIZE)
				.addGap(18).addComponent(btnViewUserAccount, GroupLayout.PREFERRED_SIZE, 34, GroupLayout.PREFERRED_SIZE)
				.addGap(18)
				...
				.addGap(18).addComponent(btnViewUserProfile, GroupLayout.PREFERRED_SIZE, 34, GroupLayout.PREFERRED_SIZE)
				.addGap(18)
